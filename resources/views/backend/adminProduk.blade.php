                    ...
                    <div class="flex-auto p-4">
                        <div class="flex flex-row -mx-3">
                            ...
                            <div class="px-3 text-right basis-1/3">
                                <div class="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-blue-700 to-blue-200">
                    ...
                    <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
                        <div class="p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                            ...
                            <div class="flex place-items-center justify-end">
                                <a href="{{ route('admin.create') }}" class="text-center bg-gradient-to-br from-blue-200 to-blue-700 rounded-xl py-1 px-1 text-white">Tambah</a>
                            </div>
                        </div>
                            ...
                            <div class="p-0 overflow-x-auto">
                                <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                                    <thead class="align-bottom">
                                        <tr>
                                            <th class="px-6 py-3 font-bold text-center uppercase align-middle bg-transparent border-b border-gray-200 shadow-none text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70">Nama Produk</th>
                                            ...
                                            <th class="px-6 py-3 font-bold text-center uppercase align-middle bg-transparent border-b border-gray-200 shadow-none text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70">Foto Produk</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent pl-5 text-wrap w-64">
                                                <div class="flex flex-col justify-center">
                                                    <h6 class="mb-0 text-sm leading-normal">{{ $item->nama_produk}}</h6>
                                                    <p class="mb-0 text-xs leading-tight text-slate-400"></p>
                                                </div>
                                            </td>
                                            <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent text-wrap">
                                                <p class="mb-0 text-xs font-semibold leading-tight"><?php echo htmlspecialchars_decode($item['desc_produk']);?>
                                            </td>
                                            <td class="p-2 text-sm leading-normal text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                @if($item->foto_produk)
                                                    <img src="{{ $item->foto_produk }}" class="rounded flex justify-center" style="width: 150px">
                                                @else
                                                    <p>No Image</p>
                                                @endif
                                            </td>
                                            <td class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                <span class="text-xs font-semibold leading-tight text-slate-400">Rp {{ number_format($item->rates->first()->nama_rate, 0, ',', '.')  }}</span>
                                            </td>
                                            <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent text-center">
                                                <a href="{{ route('admin.edit', $item->id_produk) }}" class="text-xs font-semibold leading-tight text-slate-400"> Edit </a>
                                                <form action="{{ route('admin.destroy', $item->id_produk) }}" method="post">
                                                    @csrf
                                                    @method('DELETE')
